...
export default function Brief() {
  return (
    <div className="bg-[url('../../public/BriefCover.jpg')] bg-fixed bg-cover bg-top h-[65vh] shadow-2xl">
        <div className="bg-[#000000b7] p-3 xl:p-10 pt-6 pb-6 sm:p-10 lg:p-28 w-full h-[100%] flex flex-col xl:flex-row gap-4 lg:gap-10 items-center justify-center text-white">
            {/* Brief Logo */}
