    ...
    <div className="flex flex-col items-center justify-center">
      <div className="relative w-full h-[300px] md:h-[400px] lg:h-[450px] pt-[80px] lg:pt-[100px]">
        ...
        <div className="absolute inset-0 bg-[#000000c7] flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-200 max-w-2xl leading-relaxed">
            تغطية إعلامية موسعة من القنوات والصحف الكبرى لضمان وصول رسائل المعرض
            لأكبر جمهور ممكن.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-gray-100">
          من خلال GEB Expo 2025 سيتم الإعلان عن أحدث المبادرات التعليمية
          والشراكات. تابع آخر الأخبار هنا أو من خلال وسائل الإعلام الرسمية.
        </p>
      </motion.section>

      <motion.section
        className="w-full bg-[#f5f5f5] py-12 px-6 text-center"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        transition={{ staggerChildren: 0.2 }}
      >
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-green-600 mb-8">
      ...
      <motion.section
        className="max-w-5xl text-center py-12 px-4"
      ...
      >
        ...
        <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-gray-100">
          سيتم مشاركة روابط التقارير التلفزيونية والمقالات والصور من مختلف وسائل
          الإعلام هنا بعد بداية المعرض.
        </p>
      </motion.section>
      ...
      >
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-green-500 mb-4">
          للتواصل الإعلامي
        </h2>
        <p className="text-gray-200 mb-4">
          لأي استفسارات أو لتنسيق التغطية الإعلامية، يرجى التواصل على:
        </p>
        <p className="text-lg font-bold text-green-400">media@gebexpo.com</p>
      </motion.section>
